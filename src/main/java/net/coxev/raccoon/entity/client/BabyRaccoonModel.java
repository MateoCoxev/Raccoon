...
public class BabyRaccoonModel<T extends RaccoonEntity> extends AbstractRaccoonModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = torso.addChild("head", ModelPartBuilder.create().uv(0, 25).cuboid(-4.5F, -3.25F, -6.0F, 9.0F, 7.0F, 6.0F, new Dilation(0.5F))
                .uv(36, 33).cuboid(-2.0F, 1.25F, -8.0F, 4.0F, 3.0F, 2.0F, new Dilation(0.0F)), ModelTransform.pivot(0.0F, -4.75F, -13.0F));

        ModelPartData ear_right = head.addChild("ear_right", ModelPartBuilder.create().uv(9, 8).cuboid(-1.5F, -2.5F, -0.5F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(-3.5F, -3.25F, -4.5F));

        ModelPartData ear_left = head.addChild("ear_left", ModelPartBuilder.create().uv(9, 0).cuboid(-0.5F, -2.5F, -0.75F, 2.0F, 2.0F, 1.0F, new Dilation(0.0F)), ModelTransform.pivot(3.5F, -3.25F, -4.5F));
