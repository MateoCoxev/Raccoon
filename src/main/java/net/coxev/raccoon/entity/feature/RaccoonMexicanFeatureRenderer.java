...
public class RaccoonMexicanFeatureRenderer extends FeatureRenderer<RaccoonEntity, AbstractRaccoonModel<RaccoonEntity>> {
    ...
    public RaccoonMexicanFeatureRenderer(FeatureRendererContext<RaccoonEntity, AbstractRaccoonModel<RaccoonEntity>> context, HeldItemRenderer heldItemRenderer) {
        super(context);
