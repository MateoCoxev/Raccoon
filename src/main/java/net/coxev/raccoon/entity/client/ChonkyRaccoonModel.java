...
public class ChonkyRaccoonModel<T extends RaccoonEntity> extends AbstractRaccoonModel<T> {

    public ChonkyRaccoonModel(ModelPart root) {
        super(root);
    }
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData abdomen_r1 = abdomen.addChild("abdomen_r1", ModelPartBuilder.create().uv(0, 0).cuboid(-6.0F, -4.5F, -8.0F, 12.0F, 9.0F, 16.0F, new Dilation(1.3F)), ModelTransform.of(0.0F, -1.5F, -7.0F, 0.0436F, 0.0F, 0.0F));
